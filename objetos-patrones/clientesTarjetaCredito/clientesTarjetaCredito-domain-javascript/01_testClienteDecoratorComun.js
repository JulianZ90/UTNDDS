...
var Cliente = require("./01_cliente").Cliente;
var ClienteConSafeShop = require("./01_cliente").ClienteConSafeShop;
var ClienteConPromocion = require("./01_cliente").ClienteConPromocion;
